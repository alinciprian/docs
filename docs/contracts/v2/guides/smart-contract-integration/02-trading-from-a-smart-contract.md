...
It is also important to ensure that your contract controls enough ETH/tokens to make the swap and has granted the router approval to withdraw the required amount.
...
Now that our contract owns 50 DAI, we need to approve the [router](../../reference/smart-contracts/router-02) to withdraw this DAI:
